...
namespace Course // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var r3 = products.Where(p => p.Name.ToLower().StartsWith('c')).Select(p => new {p.Name, p.Price, CategoryName = p.Category.Name });
            ...
            // UTILIZAR SOMENTE SE O WHERE RETORNAR UM OU NENHUM ELEMENTO
            ...
            var r14 = products.Where(p => p.Category.Id == 4).Select(p => p.Price).DefaultIfEmpty(0.0).Average();
